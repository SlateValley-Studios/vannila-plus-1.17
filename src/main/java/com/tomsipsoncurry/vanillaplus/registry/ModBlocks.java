    ...
    public class ModBlocks {
        ...
        public static final Block EUCALYPTUS_PLANK = new Block(FabricBlockSettings.of(Material.WOOD).strength(2.0F, 3.0F));
        public static final Block PURPUR_WALL = new WallBlock(FabricBlockSettings.of(Material.STONE).strength(2.0F, 6.0F));
        public static void RegisterBlocks() {
            Registry.register(Registry.BLOCK, new Identifier(Vanillaplus.MOD_ID, "eucalyptus_log"), EUCALYPTUS_LOG);
            Registry.register(Registry.BLOCK, new Identifier(Vanillaplus.MOD_ID, "eucalyptus_plank"), EUCALYPTUS_PLANK);
