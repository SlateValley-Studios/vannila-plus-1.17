...
public class ModItems {
    ...
    public static void registerItems() {
        ...
        Registry.register(Registry.ITEM, new Identifier(Vanillaplus.MOD_ID, "eucalyptus_planks"), new BlockItem(ModBlocks.EUCALYPTUS_PLANKS, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS)));
